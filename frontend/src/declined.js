    ...
    const fetchData = async () => {
      try {
        ...
        const [countData, activitiesData] = await Promise.all([
          ...
          activityService.getDeclinedActivities()
        ]);
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "100vh" }}>
      ...
      >
        ...
        >
         Declined activities are automatically declined and a message will be sent to the proposer once confirmed
            </h1>
        ...
        >
يتم رفض الأنشطة المرفوضة تلقائيًا وسيتم إرسال رسالة إلى مقدم الطلب بمجرد تأكيدها
        </h1>
            ...
            onMouseLeave={(e) => e.currentTarget.style.transform = "scale(1)"}>
              ...
              <div style={{ display: "flex" }}>
                ...
                <h1 style={{
                  ...
                  {activity.raison_du_choix_du_status}
                </h1>
              </div>
